...
// ANSWER: It is linear, and it has logic to stop the function at 4 runs if count===4 return
...
// ANSWER: Complexity will be determined by the string (str) that is entered by user
